...
!(function (a, b) {
  ...
  var c = [],
    ...
    k = i.hasOwnProperty,
    l = {},
    m = "2.2.5-pre b14ce54334a568eaaa107be4c441660a57c3db24",
    n = function (a, b) {
  ...
  function ua(a, b, c, d) {
    ...
    if (
      ...
      for (h = n.map(_(e, "script"), qa), i = h.length; m < o; m++)
        (j = e),
          m !== p &&
            ((j = n.clone(j, !0, !0)), i && n.merge(h, _(j, "script"))),
          c.call(a[m], j, m);
      if (i)
        for (k = h[h.length - 1].ownerDocument, n.map(h, ra), m = 0; m < i; m++)
          (j = h[m]),
            Z.test(j.type || "") &&
  ...
  n.extend({
    ...
    clone: function (a, b, c) {
      ...
      if (
        ...
        for (g = _(h), f = _(a), d = 0, e = f.length; d < e; d++)
          ta(f[d], g[d]);
      if (b)
        if (c)
          for (f = f || _(a), g = g || _(h), d = 0, e = f.length; d < e; d++)
            sa(f[d], g[d]);
        else sa(a, h);
      return (
    ...
    n.each(
      ...
      function (a, b) {
        n.fn[a] = function (a) {
          for (var c, d = [], e = n(a), f = e.length - 1, h = 0; h <= f; h++)
  ...
  n.extend({
    ...
    n.each(["height", "width"], function (a, b) {
      n.cssHooks[b] = {
        get: function (a, c, d) {
          if (c)
            return Ha.test(n.css(a, "display")) && 0 === a.offsetWidth
              ? Da(a, Ia, function () {
                  return Pa(a, b, d);
                })
              : Pa(a, b, d);
  ...
  function _a(a, b, c) {
    var d,
      ...
      k = j.props;
    for ($a(k, j.opts.specialEasing); f < g; f++)
  ...
  (n.offset = {
    ...
    n.each(["top", "left"], function (a, b) {
      n.cssHooks[b] = Ga(l.pixelPosition, function (a, c) {
        if (c)
          return (c = Fa(a, b)), Ba.test(c) ? n(a).position()[b] + "px" : c;
      });
    }),
